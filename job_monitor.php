...
$sqlCreate = "SELECT COUNT(*) FROM wood_issue WHERE issue_status IN ($phCreate) AND creation_date BETWEEN ? AND ?";
...
$sqlComplete = "SELECT COUNT(*) FROM wood_issue WHERE issue_status IN ($phComplete) AND creation_date BETWEEN ? AND ?";
